...
$FLEXPATH/bin/mxmlc ../src/org/mangui/jwplayer/media/HLSProvider.as \
	...
	-target-player="10.2"
./add-opt-in.py ../test/jwplayer5/HLSProvider5.swf
...
$FLEXPATH/bin/mxmlc ../src/org/mangui/jwplayer/media/HLSProvider6.as \
	...
	-target-player="10.2"
./add-opt-in.py ../test/jwplayer6/HLSProvider6.swf
...
./add-opt-in.py ../test/chromeless/HLSProviderChromeless.swf
...
$FLEXPATH/bin/mxmlc ../src/org/mangui/flowplayer/HLSPluginFactory.as \
	...
	-target-player="11.1"
./add-opt-in.py ../test/flowplayer/HLSProviderFlowPlayer.swf
...
./add-opt-in.py ../test/osmf/HLSProviderOSMF.swf
